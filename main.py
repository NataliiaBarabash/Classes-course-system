...
class Course:
    ...
    def __init__(self, name, start_date, number_of_lectures, teacher):
        ...
        self.teacher.teaching_lectures = self.lectures
        self.number_of_students = 0
        self.students = [self.student for self.student in range(self.number_of_students)]
        self.enrolled_by = self.students
        self.number_of_homeworks = 0
        self.homeworks = [self.homework for self.homework in range(self.number_of_homeworks)]
    ...
    def get_lecture(self, lecture_number):
        return self.lectures[lecture_number]

    def get_homeworks(self):
        return []

    def set_homework(self, object):
        if self.lecture is isinstance(Course):
            return object
...
class Lecture:
    def __init__(self, name, number, teacher):
        ...
        self.number = number
        self.teacher = teacher
        self.lectures = self.teacher.teaching_lectures
...
class Student:
    def __init__(self, first_name, last_name):
        ...
        self.students = [f'Student: {first_name} {last_name}']
    ...
    def enroll(self, course_name):
        new_student = f'Student: {self.first_name} {self.last_name}'
        if course_name is isinstance(self, Course):
            return self.students.append(new_student)

    def do_homework(self, functions_homework):
        pass
